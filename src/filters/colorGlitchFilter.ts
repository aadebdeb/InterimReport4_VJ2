...
import colorGlitchFragmentSource from '!!raw-loader!./shaders/colorGlitchFragment';
...
export class ColorGlitchFilter implements Filter {
  active: boolean = true;
  ...
  constructor(gl: WebGL2RenderingContext, {
    ...
    this.program = createFillViewportProgram(gl,
      new FragmentShader(gl, colorGlitchFragmentSource, new Set(Object.values(Uniforms))));
